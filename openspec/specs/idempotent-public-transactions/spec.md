# idempotent-public-transactions Specification

## Purpose
Provides an idempotent, public-standard API contract for transaction creation by authenticated companion applications, external automations, and bots.
